	...
	if relayoutRequired then
		...
		unitTypes.foreach(function(k, unitType)
			if not unitType.typeUi.uiRoot:IsHidden() then
				...
				LayoutHelpers.AtTopIn(unitType.typeUi.uiRoot, econtrol.ui, y)
				y = y + unitType.typeUi.uiRoot:Height()
			end
		end)
		econtrol.ui.Height:Set(y)
	end
end
...
function buildUi()
	local a, b = pcall(function()
		...
		local dragger = import('/mods/ResourceControl/modules/ui.lua').buttons.dragButton
		...
		unitTypes.foreach(function(k, unitType)
			...
			local iconName = '/mods/ResourceControl/textures/category_icons/' .. unitType.icon .. '.dds'
			...
			typeUi.productionPausedStatusIcon = StatusIcon(typeUi.uiRoot, spendTypes.PRODUCTION,
				'/mods/ResourceControl/textures/category_icons/icon_paused.dds')
			...
			typeUi.productionAutoPausedStatusIcon = StatusIcon(typeUi.uiRoot, spendTypes.PRODUCTION,
				'/mods/ResourceControl/textures/category_icons/icon_autopaused.dds')
			...
			typeUi.productionPrioritizedStatusIcon = StatusIcon(typeUi.uiRoot, spendTypes.PRODUCTION,
				'/mods/ResourceControl/textures/category_icons/icon_prioritized.dds')
