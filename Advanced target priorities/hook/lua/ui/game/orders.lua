...
local PrioritySettings = {
    ...
    priorityTables = {
        ...
        Bomber = "{categories.AIR * categories.BOMBER, " ..
            "categories.AIR * categories.GROUNDATTACK}",
...
KeyMapper.SetUserKeyAction('Toggle_snipe_default',
    { action = 'UI_Lua import("/lua/ui/game/orders.lua").ToggleMode()', category = 'Target priorities', order = 103 })
KeyMapper.SetUserKeyAction('Shift_Toggle_snipe_default',
    { action = 'UI_Lua import("/lua/ui/game/orders.lua").ToggleMode()', category = 'Target priorities', order = 104 })
