...
function CreateSettingsWindow()
    ...
    settingsWindow.CheckBoxLockWindow.text = UIUtil.CreateText(settingsWindow, "Lock window position", 14,
        UIUtil.bodyFont)
    ...
    while i < 7 do
        ...
        settingsWindow.dropdowns1[i].OnClick = function(self, index, text, skipUpdate)
            if index == 1 then
                ...
                prioritySettingsPrefs.buttonLayoutSeparate[1][self.Number] = settingsWindow.dropdowns1[1].itemArray[
                    index]
            end
        ...
        if i == 1 then
            ...
            if prioritySettingsPrefs.buttonLayoutSeparate[1][1] then
                settingsWindow.dropdowns1[1]:SetItem(settingsWindow.dropdowns1[1].ID[
                    prioritySettingsPrefs.buttonLayoutSeparate[1][1] ])
            end
            ...
            if prioritySettingsPrefs.buttonLayoutSeparate[1][i] then
                settingsWindow.dropdowns1[i]:SetItem(settingsWindow.dropdowns1[1].ID[
                    prioritySettingsPrefs.buttonLayoutSeparate[1][i] ])
            end
        end
    ...
    while i < 7 do
        ...
        settingsWindow.dropdowns2[i].OnClick = function(self, index, text, skipUpdate)
            if index == 1 then
                ...
                prioritySettingsPrefs.buttonLayoutSeparate[2][self.Number] = settingsWindow.dropdowns1[1].itemArray[
                    index]
            end
        ...
        if prioritySettingsPrefs.buttonLayoutSeparate[2][i] then
            settingsWindow.dropdowns2[i]:SetItem(settingsWindow.dropdowns1[1].ID[
                prioritySettingsPrefs.buttonLayoutSeparate[2][i] ])
        end
    ...
    while i < 7 do
        ...
        settingsWindow.dropdowns3[i].OnClick = function(self, index, text, skipUpdate)
            if index == 1 then
                ...
                prioritySettingsPrefs.buttonLayoutSeparate[3][self.Number] = settingsWindow.dropdowns1[1].itemArray[
                    index]
            end
        ...
        if prioritySettingsPrefs.buttonLayoutSeparate[3][i] then
            settingsWindow.dropdowns3[i]:SetItem(settingsWindow.dropdowns1[1].ID[
                prioritySettingsPrefs.buttonLayoutSeparate[3][i] ])
        end
    ...
    ---abilities.dds---
    settingsWindow.AbilitiesTexture = Bitmap(settingsWindow,
        UIUtil.UIFile('/mods/Advanced target priorities/textures/Abilities.dds'))
